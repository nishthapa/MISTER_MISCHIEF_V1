...
const char* autoDict[] = {
    ...
    "UPRIGHT_ANGLE_TOLERANCE", "SMOOTHED_PERFECTLY_STILL_ENERGY_MAX", "RAW_PERFECTLY_STILL_ENERGY_MAX", "STEADY_HOLD_ENERGY_MAX",
...
void CommandProcessor::handleSet(String varName, String valStr) {
    ...
    */
    ...
    else if (varName == "SMOOTHED_PERFECTLY_STILL_ENERGY_MAX") { SysConfig.SMOOTHED_PERFECTLY_STILL_ENERGY_MAX = valStr.toFloat(); }
    else if (varName == "RAW_PERFECTLY_STILL_ENERGY_MAX") { SysConfig.RAW_PERFECTLY_STILL_ENERGY_MAX = valStr.toFloat(); }
...
void CommandProcessor::handleGet(String varName, String valStr) {
    ...
    else if (varName == "SMOOTHED_PERFECTLY_STILL_ENERGY_MAX") { 
        if (wantDefaultOnly) logger.printf("[SMOOTHED_PERFECTLY_STILL_ENERGY_MAX] Default: %.1f\n", FactoryDefaults::SMOOTHED_PERFECTLY_STILL_ENERGY_MAX);
        else logger.printf("[SMOOTHED_PERFECTLY_STILL_ENERGY_MAX] Current: %.1f | Default: %.1f\n", SysConfig.SMOOTHED_PERFECTLY_STILL_ENERGY_MAX, FactoryDefaults::SMOOTHED_PERFECTLY_STILL_ENERGY_MAX);
    }
    else if (varName == "RAW_PERFECTLY_STILL_ENERGY_MAX") { 
        if (wantDefaultOnly) logger.printf("[RAW_PERFECTLY_STILL_ENERGY_MAX] Default: %.1f\n", FactoryDefaults::RAW_PERFECTLY_STILL_ENERGY_MAX);
        else logger.printf("[RAW_PERFECTLY_STILL_ENERGY_MAX] Current: %.1f | Default: %.1f\n", SysConfig.RAW_PERFECTLY_STILL_ENERGY_MAX, FactoryDefaults::RAW_PERFECTLY_STILL_ENERGY_MAX);
    }
